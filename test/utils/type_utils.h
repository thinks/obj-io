...
template<typename T>
struct VecSize<Vec2<T>> { static constexpr std::size_t value = 2; };

template<typename T>
struct VecSize<Vec3<T>> { static constexpr std::size_t value = 3; };

template<typename T>
struct VecSize<Vec4<T>> { static constexpr std::size_t value = 4; };
...
struct VecMaker<Vec2<FloatT>>
{
  ...
  {
    static_assert(
      VecSize<Vec2<FloatT>>::value <= std::tuple_size<std::array<T, N>>::value,
...
struct VecMaker<Vec3<FloatT>>
{
  ...
  {
    static_assert(
      VecSize<Vec3<FloatT>>::value <= std::tuple_size<std::array<T, N>>::value,
      "vec type must be smaller or equal than array");
...
struct VecMaker<Vec4<FloatT>>
{
  ...
  {
    static_assert(
      VecSize<Vec4<FloatT>>::value <= std::tuple_size<std::array<T, N>>::value,
      "vec type must be smaller or equal than array");
